...
/**
 * useBudgetSummary — fetches budget breakdown from backend.
 * Returns { totalBudget, spent, remaining, overBudget } computed server-side.
 * No client-side math — backend is the single source of truth.
 */
...
/**
 * ProjectCard — displays a single project with budget summary.
 * Clicking opens the ProjectDetailModal via the onClick prop.
 */
